...
/**
 * UpdateMsNameByMsId bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class UpdateMsNameByMsId implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "updateMsNameByMsId", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":updateMsNameByMsId", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "updateMsNameByMsId", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localMsNameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "msName"));
    ...
    public static class Factory {
         ...
         */
        public static UpdateMsNameByMsId parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            UpdateMsNameByMsId object = new UpdateMsNameByMsId();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateMsNameByMsId".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateMsNameByMsId) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "msName").equals(reader
                        .getName())) {
