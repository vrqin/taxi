...
<article>
    ...
    <div>
        <form id="form">
            <p>用户名</p>
            <input type="text" name="username" placeholder="请输入您的用户名" class="text" autocomplete="off">
            <p>密码</p>
            <input type="password" name="password" placeholder="请输入您的密码" class="text" autocomplete="off">
            <input type="hidden" name="cgflag" value="4" autocomplete="off"/>
            <p id="errorTips"></p>
