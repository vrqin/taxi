...
<script>
    $(function () {
        ...
        function acquireData(key) {
            var dataurl = path + "/usagePlatform/findUsagePlatformForPageList?startime=&endtime="
            ...
            grid = $("#redataGril").datagrid({
                ...
                columns: [
                    [
                        ...
                        {field: 'onlinenum', title: '在线车辆数', width: 100, align: 'center', sortable: true},
                        {field: 'offlinenum', title: '离线车辆数', width: 100, align: 'center'},
                        {field: 'emptynum', title: '空车数量', width: 100, align: 'center', sortable: true},
                        {field: 'heavynum', title: '重车数量', width: 100, align: 'center', sortable: true}
                    ]
                ],
