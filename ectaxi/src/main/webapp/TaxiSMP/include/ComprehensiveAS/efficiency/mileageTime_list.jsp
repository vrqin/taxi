        ...
        */
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#month").datagrid({
                url: path + "/operateRangeTimeMonth/findOperateRangeTimeMonthForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
                    ...
                    {field: "operaterange", title: "营运里程（Km）", width: 100, align: "center", sortable: true},
                    {field: "passmiles", title: "载客里程（Km）", width: 100, align: "center", sortable: true},
                    {field: "emptydistance", title: "空驶里程（Km）", width: 100, align: "center", sortable: true},
                    {field: "mileageutilization", title: "里程利用率（%）", width: 100, align: "center", sortable: true},
                ]],
                idField: 'years',
                sortName: 'years',
                sortOrder: 'desc',
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#day").datagrid({
                url: path + "/operateRangeTimeCycle/findOperateRangeTimeCycleForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function hourData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#hour").datagrid({
                url: path + "/operateRangeTimeHours/findOperateRangeTimeHoursForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
