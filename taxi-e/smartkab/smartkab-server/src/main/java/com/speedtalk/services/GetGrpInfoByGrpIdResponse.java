/**
 * GetGrpInfoByGrpIdResponse.java
 * <p>
...
/**
 * GetGrpInfoByGrpIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetGrpInfoByGrpIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getGrpInfoByGrpIdResponse", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getGrpInfoByGrpIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getGrpInfoByGrpIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetGrpInfoByGrpIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetGrpInfoByGrpIdResponse object = new GetGrpInfoByGrpIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getGrpInfoByGrpIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetGrpInfoByGrpIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(com.speedtalk.datas.xsd.GrpInfo.Factory.parse(reader));
