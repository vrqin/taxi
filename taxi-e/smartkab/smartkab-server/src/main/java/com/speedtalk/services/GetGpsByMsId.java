...
/**
 * GetGpsByMsId bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetGpsByMsId implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getGpsByMsId", "ns5");
    ...
    protected String localBegTime;
    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localBegTimeTracker = false;
    /**
     * field for EndTime
     */
    ...
    protected String localReserve;
    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localReserveTracker = false;
    ...
    public boolean isBegTimeSpecified() {
        return localBegTimeTracker;
    }
     ...
     * @param param BegTime
     */
    public void setBegTime(String param) {
        localBegTimeTracker = true;

        this.localBegTime = param;
    ...
    public boolean isReserveSpecified() {
        return localReserveTracker;
    }
     ...
     * @param param Reserve
     */
    public void setReserve(String param) {
        localReserveTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getGpsByMsId", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getGpsByMsId", xmlWriter);
            }
        ...
        if (localBegTimeTracker) {
            namespace = "http://services.speedtalk.com";
            writeStartElement(null, namespace, "begTime", xmlWriter);


            if (localBegTime == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localBegTime);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localBegTimeTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "begTime"));

            elementList.add(localBegTime == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBegTime));
        }
        if (localEndTimeTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "endTime"));

            elementList.add(localEndTime == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEndTime));
        }
        if (localReserveTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "reserve"));

            elementList.add(localReserve == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReserve));
        }
    ...
    public static class Factory {
         ...
         */
        public static GetGpsByMsId parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetGpsByMsId object = new GetGpsByMsId();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getGpsByMsId".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetGpsByMsId) com.speedtalk.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "begTime")
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setBegTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "endTime")
                        .equals(reader.getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "reserve")
                        .equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setReserve(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
