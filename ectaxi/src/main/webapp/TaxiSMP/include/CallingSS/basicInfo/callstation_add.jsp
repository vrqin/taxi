...
<script>
    ...
    function loadvalue() {
        ...
        var requestURL = path + '/callstation/findCallstationByid?id=' + '${param.id}' + "&clientid=" + globab_clientId;
...
//				////console.info(data);
    ...
    */
    function completedForm(dialog, grid, p) {
        ...
        var requestURL = path + "/callstation/saveorupdateCallstationObject";
        $.ajax({
            type: "POST",
            crossDomain: true,
            url: requestURL,
