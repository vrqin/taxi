...
/**
 * 163.tab_enterprise_revenue_analysis_month企业营收分析-月份
 * Created by Administrator on 2016/10/7.
 */
@Entity
@Table(name = "tab_enterprise_revenue_analysis_month")
public class EnterpriseRevenueAnalysisMonth implements Serializable {
    private int id;
