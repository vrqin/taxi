...
<script>
    $(function () {
        ...
        function acquireData(key) {
            var dataurl = path + "/driverviodeltails/findDriverVioDeltailsForPageList?startime=&endtime="
            ...
            grid = $("#redataGril").datagrid({
                ...
                columns: [
                    [
                        ...
                        {
                            field: 'type', title: '违规类型', width: 100, align: 'center',
                            formatter: function (value) {
                                return getValueFromArray(value, viostutet);
                            }
                        },
                        {field: 'viotime', title: '违规时间', width: 100, align: 'center'}
//                        {field: 'detailed', title: '详细', width: 100, align: 'center',sortable:true}
                    ]
                ],
