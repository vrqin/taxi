...
<div id="monthtoolbar">
    <div id="input" style="font-size:12px;">
        ...
        <input id="endtime2" class="easyui-datetimespinner"
               data-options="width:100,formatter:formatter2,parser:parser2,selections:[[0,4],[5,7]]"/>
        <label>&nbsp;关键字</label>
        <input id="key2" class="easyui-textbox" prompt="企业名称 | 车牌号码"/>&nbsp;
...
<div id="daytoolbar">
    <div id="input" style="font-size:12px;">
        ...
        <label>&nbsp;关键字</label>
        <input id="key3" class="easyui-textbox" prompt="企业名称 | 车牌号码"/>&nbsp;
    	...
    	*/
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#month").datagrid({
                url: path + "/driverIncomeRanking/findDriverIncomeRankingForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#day").datagrid({
                url: path + "/driverIncomeRankingDay/findDriverIncomeRankingDayForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
