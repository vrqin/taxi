...
<script>
    var grid;
    var data = [
//        { "kabnum": " ","driver": " ","unit": "  ", "starttime": " ", "endtime": " ", "time": " ", "speed": " ", "limitspeed": " ", "abnormallocation": " "}
    ];
    $(function () {
...
//                height: $("#dataview").height() -300+"px",
            ...
            columns: [
                [
                    ...
                    {field: 'starttime', title: '开始时间', width: fixWidth(0.1), align: 'center'},
                    {field: 'endtime', title: '结束时间', width: fixWidth(0.1), align: 'center'},
                    {field: 'time', title: '时间', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'speed', title: '车速（KM/h）', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'limitspeed', title: '限速（KM/h）', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'abnormallocation', title: '异常地点', width: fixWidth(0.1), align: 'center', sortable: true}
