...
<script>
    ...
    $(function () {
        ...
        function acquireData(notifierid) {
            var dataUrl = 'sort=id&order=desc&type=-1&begintime=&endtime=&key=' + notifierid + "&clientid=" + globab_clientId;
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/discountPassenger/findDiscountPassengerForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        {field: 'opruser', title: '乘客', width: 100, align: 'center', sortable: true},
                        {
                            field: 'isreceive', title: '是否领取', width: 100, align: 'center', sortable: true,
                            formatter: function (value) {
                                return getValueFromArray(value, isreceive);
                            }
                        },
                        {
                            field: 'isuse', title: '是否使用', width: 100, align: 'center', sortable: true,
                            formatter: function (value) {
                                return getValueFromArray(value, isusevalue);
                            }
                        },
