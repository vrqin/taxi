...
<div id="toolbar">
    <div id="input">
        <label>关键字</label>
        <input id="key" class="easyui-textbox" data-options="width:160" prompt="企业名称 | 驾驶员名称">
        <!--<label>&nbsp;时间</label>
        ...
        */
        function acquireData(key) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/driverIntegratedQuery/findDriverIntegratedQueryForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        ...
                        {
                            field: 'daytime', title: '日均时长', width: 100, align: 'center', sortable: true,
                            formatter: function (value, row, index) {
                                if (value > 0) {
                                    return formatSeconds(value);
                                } else {
