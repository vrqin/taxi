...
/**
 * 151.tab_total_duration_analysis_month总时长分析-月份
 * Created by Administrator on 2016/10/7.
 */
@Entity
@Table(name = "tab_total_duration_analysis_month")
public class TotalDurationAnalysisMonth implements Serializable {
    private int id;
