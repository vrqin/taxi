...
/**
 * GetMsListByGrpIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetMsListByGrpIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getMsListByGrpIdResponse", "ns5");
    ...
    protected com.speedtalk.datas.xsd.MsInfoExt[] local_return;
     ...
     *
     * @return com.speedtalk.datas.xsd.MsInfoExt[]
     */
    public com.speedtalk.datas.xsd.MsInfoExt[] get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(com.speedtalk.datas.xsd.MsInfoExt[] param) {
     ...
     */
    protected void validate_return(com.speedtalk.datas.xsd.MsInfoExt[] param) {
     ...
     *
     * @param param com.speedtalk.datas.xsd.MsInfoExt
     */
    public void add_return(com.speedtalk.datas.xsd.MsInfoExt param) {
        if (local_return == null) {
            local_return = new com.speedtalk.datas.xsd.MsInfoExt[]{};
        }
        ...
        list.add(param);
        this.local_return = (com.speedtalk.datas.xsd.MsInfoExt[]) list.toArray(new com.speedtalk.datas.xsd.MsInfoExt[list
                .size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getMsListByGrpIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getMsListByGrpIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetMsListByGrpIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetMsListByGrpIdResponse object = new GetMsListByGrpIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getMsListByGrpIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetMsListByGrpIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list1.add(com.speedtalk.datas.xsd.MsInfoExt.Factory.parse(reader));
                    }
                    ...
                    object.set_return((com.speedtalk.datas.xsd.MsInfoExt[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.speedtalk.datas.xsd.MsInfoExt.class, list1));
