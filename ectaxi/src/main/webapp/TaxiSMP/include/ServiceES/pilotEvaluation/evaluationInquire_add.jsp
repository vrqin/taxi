    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><label><span class="required">*</span> 车牌号：</label><input id="kabnum" name="account"
                                                                          class="easyui-textbox"
                                                                          data-options="required:true"/></td>
            <td><label><span class="required">*</span> 取系电话：</label><input id="phone" name="account"
                                                                           class="easyui-textbox"
                                                                           data-options="required:true"/></td>
        </tr>
...
//		});
    ...
    function loadvalue() {
        $.ajax({
            url: path + '/driverEvaluationQuery/findDriverEvaluationQueryByid?id=' +${param.id},
            dataType: "json",
            type: "GET",
            success: function (data) {
                //console.info(data);
                ...
                $("#evaluationlevel").textbox('setValue', evaluationlevelFormat(data.evaluationlevel));
    ...
    function completedForm(dialog, grid, p) {
        ...
        var requestURL = path + "/driverEvaluationQuery/saveorupdateDriverEvaluationQuery";
