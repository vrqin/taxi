...
/**
 * GetSysDateMillisResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetSysDateMillisResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getSysDateMillisResponse", "ns5");
    ...
    public void set_return(long param) {
        ...
        local_returnTracker = param != Long.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getSysDateMillisResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getSysDateMillisResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetSysDateMillisResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetSysDateMillisResponse object = new GetSysDateMillisResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getSysDateMillisResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetSysDateMillisResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    object.set_return(Long.MIN_VALUE);
