        ...
        */
        $("#delete").click(function () {
            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: path + '/passenger/delPassByid?opruser=' + row.opruser,
                        dataType: "json",
                        type: "GET",
        ...
        */
        function acquireData(key) {
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/passenger/findSeatsForPageList?startime=&endtime=&type=1&order=desc&sort=id&key=" + key + "&clientid=" + globab_clientId,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        {field: 'account', title: '帐号', width: 100, align: 'center', sortable: true},
                        {field: 'name', title: '坐席人员姓名', width: 100, align: 'center', sortable: true},
