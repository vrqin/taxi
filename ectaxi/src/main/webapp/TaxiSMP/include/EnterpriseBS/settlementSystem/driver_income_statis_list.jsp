    ...
    $(function () {
        ...
        */
        function yearData(begintime, endtime, key) {
            var dataUrl = "sort=annual&order=desc&begintime=" + begintime +
                "&endtime=" + endtime +
                "&key=" + key +
                "&clientid=" + globab_clientId;
            $("#year").datagrid({
                url: path + "/driverIncomeStatis/findDriverIncomeStatisForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
                    {field: "annual", title: "年度", width: 100, align: "center", sortable: true},
                    {field: "company", title: "司机名称", width: 100, align: "center", sortable: true},
    	...
    	*/
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&clientid=" + globab_clientId;
            $("#month").datagrid({
                url: path + "/driverIncomeStatisMonth/findDriverIncomeStatisMonthForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&clientid=" + globab_clientId;
            $("#day").datagrid({
                url: path + "/driverIncomeStatisDay/findDriverIncomeStatisDayForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
