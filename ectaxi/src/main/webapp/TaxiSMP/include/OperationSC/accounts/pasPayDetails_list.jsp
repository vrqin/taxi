...
<script>
    ...
    $(function () {
        $("#begintime").datetimebox("setValue", GetDateStr(-1));
        $("#endtime").datetimebox("setValue", GetDateStr(1));
        /*
        ** 默认加载
        */
        acquireData('', -1, GetDateStr(-1), GetDateStr(1));
        ...
        */
        function acquireData(key, way, begintime, endtime) {
            var dataUrl = 'sort=calltime&order=desc&begintime=' + begintime +
                '&endtime=' + endtime +
                '&key=' + key +
                '&payment=' + way;
            $("#redataGril").datagrid({
                ...
                columns: [
                    [
                        ...
                        {field: 'tradeno', title: '支付单号', width: 100, align: 'center', sortable: true}
