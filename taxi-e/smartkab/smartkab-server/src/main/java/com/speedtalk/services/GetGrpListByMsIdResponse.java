...
/**
 * GetGrpListByMsIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetGrpListByMsIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getGrpListByMsIdResponse", "ns5");
    ...
    protected com.speedtalk.datas.xsd.GrpInfo[] local_return;
     ...
     *
     * @return com.speedtalk.datas.xsd.GrpInfo[]
     */
    public com.speedtalk.datas.xsd.GrpInfo[] get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(com.speedtalk.datas.xsd.GrpInfo[] param) {
     ...
     */
    protected void validate_return(com.speedtalk.datas.xsd.GrpInfo[] param) {
     ...
     *
     * @param param com.speedtalk.datas.xsd.GrpInfo
     */
    public void add_return(com.speedtalk.datas.xsd.GrpInfo param) {
        if (local_return == null) {
            local_return = new com.speedtalk.datas.xsd.GrpInfo[]{};
        }
        ...
        list.add(param);
        this.local_return = (com.speedtalk.datas.xsd.GrpInfo[]) list.toArray(new com.speedtalk.datas.xsd.GrpInfo[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getGrpListByMsIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getGrpListByMsIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetGrpListByMsIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetGrpListByMsIdResponse object = new GetGrpListByMsIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getGrpListByMsIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetGrpListByMsIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list1.add(com.speedtalk.datas.xsd.GrpInfo.Factory.parse(reader));
                    }
                    ...
                    object.set_return((com.speedtalk.datas.xsd.GrpInfo[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.speedtalk.datas.xsd.GrpInfo.class, list1));
