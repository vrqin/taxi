...
/**
 * 86.tab_car_information_analysis_region车辆信息分析---地区
 * Created by Administrator on 2016/10/6.
 */
@Entity
@Table(name = "tab_car_information_analysis_region")
public class CarInformationAnalysisRegion implements Serializable {
    private int id;
