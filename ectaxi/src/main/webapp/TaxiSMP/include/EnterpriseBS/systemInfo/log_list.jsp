...
<div id="toolbar">
    <div id="input">
        ...
        <span>&nbsp;登录类型</span>
        <select class="easyui-combobox" id="type" data-options="width:90,panelHeight:'auto',editable:false">
...
<script>
    ...
    $(function () {
        ...
        $("#search").on("click", function () {
            ...
            acquireData(startime, endtime, key, type)
        });
         ...
         ** 获取数据
         */
        function acquireData(startime, endtime, key, type) {
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/loglogin/findLogLoginForPageList?startime=" + startime + "&endtime=" + endtime + "&type=" + type + "&order=desc&sort=id&key=" + key + "&clientid=" + globab_clientId,
                fitColumns: true,
                striped: true,
                columns: [
                    [
