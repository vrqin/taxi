...
<div id="toolbar">
    ...
    <div id="button">
        <button class="easyui-linkbutton" id="search3" iconCls='icon-search'>查询</button>
        <button class="easyui-linkbutton" id="reset3">重置</button>
        <button class="easyui-linkbutton" id="export3">导出</button>
    </div>
</div>
    ...
    $(function () {
        ...
        */
        function dayData(begintime, endtime, key) {
            ...
            $("#redataGril").datagrid({
                fit: true,
                url: path + "/driverSatisfactionRankings/findDriverSatisfactionRankingsForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        ...
                        {field: 'satisfaction', title: '满意度（%）', width: 100, align: 'center'},
                    ]
                ],
                idField: 'mobile',
                sortName: 'mobile',
