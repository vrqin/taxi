...
<head>
    ...
    <script>
        var grid;
        var data = [
//            { "kabnum": " ","driver": " ","unit": "  ", "starttime": " ","endtime": " ", "duration": " ","address": " "}
        ];
        $(function () {
...
//                height: $("#dataview").height() -300+"px",
                ...
                columns: [
                    [
                        ...
                        {field: 'starttime', title: '驾驶开始时间', width: fixWidth(0.1), align: 'center'},
                        {field: 'endtime', title: '驾驶结束时间', width: fixWidth(0.1), align: 'center'},
                        {field: 'duration', title: '驾驶时长', width: fixWidth(0.1), align: 'center', sortable: true},
                        {field: 'address', title: '地点', width: fixWidth(0.1), align: 'center', sortable: true}
