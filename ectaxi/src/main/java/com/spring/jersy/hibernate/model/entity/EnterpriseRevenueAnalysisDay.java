...
/**
 * 164.tab_enterprise_revenue_analysis_day企业营收分析-日期
 * Created by Administrator on 2016/10/7.
 */
@Entity
@Table(name = "tab_enterprise_revenue_analysis_day")
public class EnterpriseRevenueAnalysisDay implements Serializable {
    private int id;
