...
/**
 * 85.tab_enterprise_information_analysis_credit企业信息分析--信誉等级
 * Created by Administrator on 2016/10/6.
 */
@Entity
@Table(name = "tab_enterprise_information_analysis_credit")
public class EnterpriseInformationAnalysisCredit implements Serializable {
    private int id;
    ...
    private int inspection;//	int(11)			未考核
