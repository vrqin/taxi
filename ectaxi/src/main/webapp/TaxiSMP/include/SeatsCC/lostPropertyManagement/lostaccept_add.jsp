...
<table class="table">
    ...
    <tr>
        <td>查找结果：
            <select class="easyui-combobox" id="results" data-options="width:168,panelHeight:'auto',editable:false">
                <option value="0">找到</option>
                <option value="1" selected>未找到</option>
...
//						console.info(data);
        ...
        */
        function loadvalue() {
            $.ajax({
                url: path + '/lostaccept/findNameByid?id=' +${param.id},
                dataType: "json",
                type: "GET",
                success: function (data) {
                    ...
                    $('#calltime').datetimebox("setValue", formattime(data.calltime.time));
    ...
    */
    function completedForm(dialog, grid, p) {
        ...
        var dataUrl = "id=" + id +
            ...
            "&results=" + results;
        $.ajax({
            url: path + '/lostaccept/saveorupdatelostAccept?' + dataUrl,
            dataType: "json",
            type: "POST",
            success: function (data) {
