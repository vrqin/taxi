        ...
        */
        function yearData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#year").datagrid({
                url: path + "/totalDurationAnalysisYear/findTotalDurationAnalysisYearForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#month").datagrid({
                url: path + "/totalDurationAnalysisMonth/findTotalDurationAnalysisMonthForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#day").datagrid({
                url: path + "/totalDurationAnalysisDay/findTotalDurationAnalysisDayForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
