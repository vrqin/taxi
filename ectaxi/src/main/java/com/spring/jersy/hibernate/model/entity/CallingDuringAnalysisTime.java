...
/**
 * 102.tab_calling_during_analysis_time电召时段分析-时间段
 * <p>
 * Created by Administrator on 2016/10/6.
 */
@Entity
@Table(name = "tab_calling_during_analysis_time")
public class CallingDuringAnalysisTime implements Serializable {
    private int id;
    private String hours;//	varchar(11)			小时
