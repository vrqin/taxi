        ...
        */
        function yearData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#year").datagrid({
                url: path + "/mileageIncomeAnalysisYear/findMileageIncomeAnalysisYearForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
                    ...
                    {field: "totalmiles", title: "里程总数（公里）", width: 100, align: "center", sortable: true},
                    {field: "callmiles", title: "电召里程（公里）", width: 100, align: "center", sortable: true},
                    {field: "callmilesratio", title: "电召里程利用比例（%）", width: 100, align: "center", sortable: true},
                    {field: "driverincome", title: "驾驶员收入（元）", width: 100, align: "center", sortable: true},
                    {field: "drivercallincome", title: "驾驶员电召收入（元）", width: 100, align: "center", sortable: true},
                    {field: "callincomeratio", title: "电召收入比例（%）", width: 100, align: "center", sortable: true},
                ]],
                idField: 'years',
                sortName: 'years',
                sortOrder: 'desc',
    	...
    	*/
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#month").datagrid({
                url: path + "/mileageIncomeAnalysisMonth/findMileageIncomeAnalysisMonthForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#day").datagrid({
                url: path + "/mileageIncomeAnalysisDay/findMileageIncomeAnalysisDayForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
