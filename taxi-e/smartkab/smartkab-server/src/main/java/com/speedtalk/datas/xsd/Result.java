...
public class Result implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setResult(int param) {
        ...
        localResultTracker = param != Integer.MIN_VALUE;
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localMsgTracker) {
            elementList.add(new javax.xml.namespace.QName("http://datas.speedtalk.com/xsd", "msg"));

            elementList.add(localMsg == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMsg));
        }
        if (localResultTracker) {
    ...
    public static class Factory {
        ...
        public static Result parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Result".equals(type)) {
                            ...
                            return (Result) com.speedtalk.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://datas.speedtalk.com/xsd", "msg").equals(reader
                        .getName())) {
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setMsg(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://datas.speedtalk.com/xsd", "result")
                    ...
                    object.setResult(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                    ...
                    object.setResult(Integer.MIN_VALUE);
