...
<script>
    ...
    $(function () {
        ...
        */
        ...
        acquireData(startime, endtime, -1, -1);


        /*
        ** 获取数据
        */
        function acquireData(startime, endtime, status, ordertype) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/callbuss/findCallBussForPageListByDate?" + DataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
