/**
 * UpdateGrpNameByGrpIdResponse.java
 * <p>
...
/**
 * UpdateGrpNameByGrpIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class UpdateGrpNameByGrpIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "updateGrpNameByGrpIdResponse", "ns5");
    ...
    protected com.speedtalk.datas.xsd.Result local_return;
     ...
     */
    public com.speedtalk.datas.xsd.Result get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(com.speedtalk.datas.xsd.Result param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":updateGrpNameByGrpIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "updateGrpNameByGrpIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static UpdateGrpNameByGrpIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            UpdateGrpNameByGrpIdResponse object = new UpdateGrpNameByGrpIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateGrpNameByGrpIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateGrpNameByGrpIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(com.speedtalk.datas.xsd.Result.Factory.parse(reader));
