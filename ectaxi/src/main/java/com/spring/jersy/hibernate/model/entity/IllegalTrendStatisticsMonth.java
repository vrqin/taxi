...
/**
 * 173.tab_illegal_trend_statistics_month违章趋势统计-月份
 * <p>
 * Created by Administrator on 2016/10/7.
 */
@Entity
@Table(name = "tab_illegal_trend_statistics_month")
public class IllegalTrendStatisticsMonth implements Serializable {
    private int id;
