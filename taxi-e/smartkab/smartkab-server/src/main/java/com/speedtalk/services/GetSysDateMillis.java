...
/**
 * GetSysDateMillis bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetSysDateMillis implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getSysDateMillis", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getSysDateMillis", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getSysDateMillis", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetSysDateMillis parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetSysDateMillis object = new GetSysDateMillis();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getSysDateMillis".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetSysDateMillis) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
