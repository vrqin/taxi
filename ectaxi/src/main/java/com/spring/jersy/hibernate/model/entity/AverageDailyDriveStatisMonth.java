...
/**
 * 113.tab_average_daily_drive_statis_month日均出车统计-月份
 * Created by Administrator on 2016/10/6.
 */
@Entity
@Table(name = "tab_average_daily_drive_statis_month")
public class AverageDailyDriveStatisMonth implements Serializable {
    private int id;
    private int cycle;//	varchar(11)			年度
