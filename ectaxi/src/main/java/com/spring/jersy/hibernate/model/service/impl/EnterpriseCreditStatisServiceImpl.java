...
@Service
public class EnterpriseCreditStatisServiceImpl implements EnterpriseCreditStatisService {

    @Autowired
    private EnterpriseCreditStatisDao enterpriseCreditStatisDao;
    ...
    public List<EnterpriseCreditStatis> findList(String sort, String order, String key, String begintime, String endtime) throws Exception {
        DetachedCriteria dc = DetachedCriteria.forClass(EnterpriseCreditStatis.class);
        ...
        return enterpriseCreditStatisDao.findByDetachedCriteria(dc);
    }

    @Override
    public EnterpriseCreditStatis findByid(Integer id) {
        return enterpriseCreditStatisDao.get(id);
    }

    @Override
    public void delete(Integer id) {
        enterpriseCreditStatisDao.delete(id);
    }

    @Override
    public void save(EnterpriseCreditStatis enterpriseCreditStatis) {
        enterpriseCreditStatisDao.save(enterpriseCreditStatis);
    }

    @Override
    public void saveOrUpd(EnterpriseCreditStatis enterpriseCreditStatis) {
        enterpriseCreditStatisDao.saveOrUpdate(enterpriseCreditStatis);
    }
}
