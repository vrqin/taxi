...
<div id="toolbar">
    <div style="margin: 10px;padding: 10px;border: 1px solid #c8c8c8;">
        ...
        <select id="results" class="easyui-combobox" data-options="width:80,panelHeight:'auto',editable:false">
            <option value="-1">全部</option>
            <option value="0">找到</option>
            <option value="1">未找到</option>
    ...
    $(function () {
        ...
        */
        ...
        $("#search").click(function () {
            ...
            acquireData(startime, endtime, classify, results, key)
        });
        ...
        */
        $("#delete").click(function () {
            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: path + "/lostaccept/delLostAcceptByid?id=" + row.id + "&token=" + token + "&clientid=" + globab_clientId,
                        dataType: "json",
                        type: "GET",
        ...
        */
        $("#modify").click(function () {
            ...
            var dialog = phm.modalDialog({
                title: '修改司机信息',
                closable: true,
                url: "lostaccept_add.jsp?id=" + row.id,
                buttons: [
                    {
                        text: '保存',
                        iconCls: 'icon-save',
        ...
        ** 获取数据
        */
        function acquireData(startime, endtime, classify, results, key) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/lostaccept/findLostAcceptForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        ...
                        {
                            field: 'calltime', title: '来电时间', width: 100, align: 'center'
                        },
                        {
                        ...
                        {field: 'kabnum', title: '乘坐车辆', width: 100, align: 'center'},
                        {
                            field: 'results', title: '查找结果', width: 100, align: 'center',
                            formatter: function (value) {
                                switch (value) {
                                    case 0 :
                                        return "找到";
