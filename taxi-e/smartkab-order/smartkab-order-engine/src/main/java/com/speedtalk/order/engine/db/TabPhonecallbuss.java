...
public class TabPhonecallbuss implements java.io.Serializable {
     ...
     * minimal constructor
     */
    public TabPhonecallbuss(String billid, int status, String opruser, String callnumber, String carbox, String msid, Timestamp calltime, byte ordertype) {
        this.billid = billid;
        this.status = status;
    ...
    public String toString() {
        return "TabPhonecallbuss [billid=" + billid + ", enterpriseid=" + enterpriseid + ", status=" + status + ", opruser=" + opruser + ", callnumber=" + callnumber + ", carbox=" + carbox + ", msid=" + msid + "]";
    }
}
