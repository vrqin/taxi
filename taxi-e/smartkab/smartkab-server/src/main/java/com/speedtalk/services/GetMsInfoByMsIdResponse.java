...
/**
 * GetMsInfoByMsIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetMsInfoByMsIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getMsInfoByMsIdResponse", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getMsInfoByMsIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getMsInfoByMsIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetMsInfoByMsIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetMsInfoByMsIdResponse object = new GetMsInfoByMsIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getMsInfoByMsIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetMsInfoByMsIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(com.speedtalk.datas.xsd.MsInfoExt.Factory.parse(reader));
