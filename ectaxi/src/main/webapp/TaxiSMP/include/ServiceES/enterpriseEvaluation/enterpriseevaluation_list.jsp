        ...
        */
        ...
        $("#add").click(function () {
            ...
            var dialog = phm.modalDialog({
                ...
                height: 450,
                closable: true,
                url: "enterpriseevaluation_add.jsp?id=0",
                buttons: [
                    {
                        text: '提交',
                        iconCls: 'icon-save',
        ...
        $("#modify").click(function () {
            ...
            var dialog = phm.modalDialog({
                ...
                height: 450,
                closable: true,
                url: "enterpriseevaluation_add.jsp?id=" + row.id + "&type=1",
                buttons: [
                    {
                        text: '保存',
                        iconCls: 'icon-save',
        ...
        $("#delete").click(function () {
            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                if (r) {
                    ...
                    var requestURL = path + "/enterpriseEvaluation/delEnterpriseEvaluationByid?id=" + row.id + "&token=" + token;
        ...
        */
        function acquireData(key) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/enterpriseEvaluation/findEnterpriseEvaluationForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        ...
                        {field: 'evaluationyear', title: '考评年度', width: 100, align: 'center', sortable: true},
