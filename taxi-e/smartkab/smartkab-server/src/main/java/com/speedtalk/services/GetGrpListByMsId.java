...
/**
 * GetGrpListByMsId bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetGrpListByMsId implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getGrpListByMsId", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getGrpListByMsId", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getGrpListByMsId", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetGrpListByMsId parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetGrpListByMsId object = new GetGrpListByMsId();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getGrpListByMsId".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetGrpListByMsId) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
