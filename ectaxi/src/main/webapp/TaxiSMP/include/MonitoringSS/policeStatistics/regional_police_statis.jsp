...
<script>
    var grid;
    var data = [
//            { "kabnum": " ","driver": " ","unit": "  ", "areaname": " ","type": " ", "cumulative": " ","time": " "}
    ];
    $(function () {
...
//                height: $("#dataview").height() -300+"px",
            ...
            columns: [
                [
                    ...
                    {field: 'areaname', title: '区域名称', width: fixWidth(0.1), align: 'center'},
                    {field: 'type', title: '报警类型', width: fixWidth(0.1), align: 'center'},
                    {field: 'cumulative', title: '累计次数', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'time', title: '累计时间', width: fixWidth(0.1), align: 'center', sortable: true}
