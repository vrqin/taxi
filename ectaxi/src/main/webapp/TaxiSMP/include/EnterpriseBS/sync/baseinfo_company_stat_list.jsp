...
//				height: 560,
                closable: true,
                url: "baseinfo_company_stat_add.jsp?CompanyId=0",
                buttons: [
                    {
                        text: '提交',
                        iconCls: 'icon-save',
        ...
        $("#modify").click(function () {
            ...
            var lru = "baseinfo_company_stat_add.jsp?CompanyId=" + idd + "";
            console.error(lru)
            var dialog = phm.modalDialog({
                title: '修改',
//				width: 900,
        ...
        $("#delete").click(function () {
            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                if (r) {
                    ...
                    var requestURL = path + "/baseInfoCompanyStat/delBaseInfoCompanyStatByid?id=" + row.CompanyId + "&token=" + token;
        ...
        */
        function acquireData(key) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/baseInfoCompanyStat/getAll",
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        ...
                        {field: 'VehicleNum', title: '平台注册网约车数', width: 100, align: 'center'},
                        {field: 'DriverNum', title: '平台注册驾驶员数', width: 100, align: 'center'},
