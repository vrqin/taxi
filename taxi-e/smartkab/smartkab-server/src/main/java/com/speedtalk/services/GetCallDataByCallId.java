...
/**
 * GetCallDataByCallId bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetCallDataByCallId implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getCallDataByCallId", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getCallDataByCallId", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getCallDataByCallId", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localCallIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "callId"));

            elementList.add(localCallId == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCallId));
        }
        if (localBeginTimeTracker) {
            elementList.add(new javax.xml.namespace.QName("http://services.speedtalk.com", "beginTime"));
    ...
    public static class Factory {
         ...
         */
        public static GetCallDataByCallId parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetCallDataByCallId object = new GetCallDataByCallId();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCallDataByCallId".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetCallDataByCallId) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "callId").equals(reader
                        .getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "beginTime")
