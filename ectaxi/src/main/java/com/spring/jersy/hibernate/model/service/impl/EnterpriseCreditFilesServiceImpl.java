...
@Service
public class EnterpriseCreditFilesServiceImpl implements EnterpriseCreditFilesService {

    @Autowired
    private EnterpriseCreditFilesDao enterpriseCreditFilesDao;
    ...
    public List<EnterpriseCreditFiles> findList(String sort, String order, String key, String begintime, String endtime) throws Exception {
        DetachedCriteria dc = DetachedCriteria.forClass(EnterpriseCreditFiles.class);
        ...
        return enterpriseCreditFilesDao.findByDetachedCriteria(dc);
    }

    @Override
    public EnterpriseCreditFiles findByid(Integer id) {
        return enterpriseCreditFilesDao.get(id);
    }

    @Override
    public void delete(Integer id) {
        enterpriseCreditFilesDao.delete(id);
    }

    @Override
    public void save(EnterpriseCreditFiles enterpriseCreditFiles) {
        enterpriseCreditFilesDao.save(enterpriseCreditFiles);
    }

    @Override
    public void saveOrUpd(EnterpriseCreditFiles enterpriseCreditFiles) {
        enterpriseCreditFilesDao.saveOrUpdate(enterpriseCreditFiles);
    }
}
