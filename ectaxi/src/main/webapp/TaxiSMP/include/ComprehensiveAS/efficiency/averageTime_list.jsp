    ...
    $(function () {
        ...
        */
        function dayData(begintime, endtime, key) {
            ...
            $("#redataGril").datagrid({
                fit: true,
                url: path + "/averageTimeIntervalAnalysis/findAverageTimeIntervalAnalysisForPageList?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        {field: "date", title: "日期", width: 100, align: "center", sortable: true},
                        {field: 'area', title: '区域名称', width: 100, align: 'center', sortable: true},
                        {field: 'duration', title: '平均载客时间间隔（分钟）', width: 100, align: 'center'},
                    ]
                ],
                idField: 'mobile',
                sortName: 'mobile',
