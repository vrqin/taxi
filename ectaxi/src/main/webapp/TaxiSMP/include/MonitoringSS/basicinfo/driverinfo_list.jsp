        ...
        $("#delete").click(function () {
            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                if (r) {
                    ...
                    var requestURL = path + "/driver/delDriverByid?driverid=" + row.driverid + "&token=" + token + "&clientid=" + globab_clientId;
...
//                        	   ////console.info(data);
        ...
        $("#export").click(function () {
            ...
            var isonline = $('#isonline').combobox("getValue");
            var isstop = $("#isstop").combobox("getValue");
            var dataurl = "isonline=" + isonline + "&isstop=" + isstop + "&key=" + key + "&token=" + token + "&clientid=" + globab_clientId;
        ...
        */
        function acquireData(isonline, isstop, key) {
            var dataurl = path + "/driver/findDriverForPageList?startime=&endtime=&isonline=" + isonline +
                "&order=desc&sort=createtime&isstop=" + isstop + "&key=" + key + "&clientid=" + globab_clientId + "&token=" + token;
