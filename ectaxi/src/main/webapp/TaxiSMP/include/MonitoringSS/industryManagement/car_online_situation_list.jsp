...
<head>
    ...
    <script>
        var grid;
        var data = [
            {"enterprise": "测试公司", "totalnum": "325", "onlinenum": " 251", "offlinenum": "10"}
        ];
        $(function () {
            ...
            grid = $("#redataGril").datagrid({
                ...
                columns: [
                    [
                        {field: 'enterprise', title: '企业名称', width: fixWidth(0.1), align: 'center'},
                        {field: 'totalnum', title: '车辆总数', width: fixWidth(0.1), align: 'center', sortable: true},
                        {field: 'onlinenum', title: '在线车辆数', width: fixWidth(0.1), align: 'center', sortable: true},
                        {field: 'offlinenum', title: '离线车辆数', width: fixWidth(0.1), align: 'center'}
                    ]
                ],
