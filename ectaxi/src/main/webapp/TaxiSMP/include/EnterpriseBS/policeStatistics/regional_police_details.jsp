...
<script>
    var grid;
    var data = [
//            { "kabnum": " ","driver": " ","unit": "  ", "area": " ","type": " ","starttime": " ","endtime": " ", "duration": " ","address": " "}
    ];
    $(function () {
...
//                height: $("#dataview").height() -300+"px",
            ...
            columns: [
                [
                    ...
                    {field: 'area', title: '区域名称', width: fixWidth(0.1), align: 'center'},
                    {field: 'type', title: '报警类型', width: fixWidth(0.1), align: 'center'},
                    {field: 'starttime', title: '开始时间', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'endtime', title: '结束时间', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'duration', title: '时间', width: fixWidth(0.1), align: 'center', sortable: true},
                    {field: 'address', title: '异常地点', width: fixWidth(0.1), align: 'center', sortable: true}
