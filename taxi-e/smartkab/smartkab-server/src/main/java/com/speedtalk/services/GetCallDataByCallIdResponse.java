/**
 * GetCallDataByCallIdResponse.java
 * <p>
...
/**
 * GetCallDataByCallIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetCallDataByCallIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getCallDataByCallIdResponse", "ns5");
    ...
    protected com.speedtalk.datas.xsd.CallData local_return;
     ...
     *
     * @return com.speedtalk.datas.xsd.CallData
     */
    public com.speedtalk.datas.xsd.CallData get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(com.speedtalk.datas.xsd.CallData param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getCallDataByCallIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getCallDataByCallIdResponse", xmlWriter);
            }
        ...
        if (local_returnTracker) {
            if (local_return == null) {
                ...
                local_return.serialize(new javax.xml.namespace.QName("http://services.speedtalk.com", "return"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public static class Factory {
         ...
         */
        public static GetCallDataByCallIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetCallDataByCallIdResponse object = new GetCallDataByCallIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCallDataByCallIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetCallDataByCallIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.speedtalk.com", "return").equals(reader
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(com.speedtalk.datas.xsd.CallData.Factory.parse(reader));
