...
<table class="table">
    ...
    <tr id="oprusertr">
        <td>调度人员：<input id="opruser" class="easyui-textbox"/></td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr id="remarktr">
        <td colspan="2" style="text-align: left">&nbsp;&nbsp;&nbsp; 取消理由：<input id="remark" class="easyui-textbox"
                                                                                style="width: 350px"/></td>
    </tr>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data != null) {
                    ...
                    if (data.orderType == 2) {
                        $("#oprusertr").show();
                        $('#opruser').textbox('setValue', data.opruser);
                        if (data.remark != "") {
                            $("#remarktr").show();
                            $('#remark').textbox('setValue', data.remark);
                        }
