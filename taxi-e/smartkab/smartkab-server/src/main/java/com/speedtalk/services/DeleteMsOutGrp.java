...
/**
 * DeleteMsOutGrp bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class DeleteMsOutGrp implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "deleteMsOutGrp", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":deleteMsOutGrp", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "deleteMsOutGrp", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DeleteMsOutGrp parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            DeleteMsOutGrp object = new DeleteMsOutGrp();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deleteMsOutGrp".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DeleteMsOutGrp) com.speedtalk.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
