...
<script>
    $(function () {
        ...
        function acquireData(key) {
            var dataurl = path + "/operatStatis/findOperatStatisForPageList?startime=&endtime="
                + "&order=desc&sort=passmile&key=" + key + "&token=" + token + "&clientid=" + globab_clientId;
            grid = $("#redataGril").datagrid({
                ...
                columns: [
                    [
                        ...
                        {field: 'company', title: '企业', width: 100, align: 'center'},
