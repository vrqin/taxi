...
<form id="vaildateform" method="post">
    <table class="table">
        ...
        <tr>
            ...
            <td><label><span class="required">*</span> 企业名称：</label><input id="enterprisename" name="reversionManage"
                                                                           class="easyui-textbox" name="reversionManage"
                                                                           data-options="required:true"/></td>
            <td><label><span class="required">*</span> 考评年度：</label><input id="evaluationyear" class="easyui-textbox"
...
//		});
    ...
    function loadvalue() {
        $.ajax({
            url: path + '/enterpriseEvaluation/findEnterpriseEvaluationByid?id=' +${param.id},
            dataType: "json",
            type: "GET",
            success: function (data) {
                //       console(data);
                ...
                $('#evaluationyear').textbox("setValue", data.evaluationyear);
    ...
    function completedForm(dialog, grid, p) {
        ...
        var evaluationyear = $('#evaluationyear').textbox("getValue");
        ...
        var requestURL = path + "/enterpriseEvaluation/saveorupdateEnterpriseEvaluation";
