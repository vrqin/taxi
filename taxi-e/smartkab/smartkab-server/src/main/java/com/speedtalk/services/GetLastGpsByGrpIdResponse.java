/**
 * GetLastGpsByGrpIdResponse.java
 * <p>
...
/**
 * GetLastGpsByGrpIdResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GetLastGpsByGrpIdResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.speedtalk.com", "getLastGpsByGrpIdResponse", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":getLastGpsByGrpIdResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getLastGpsByGrpIdResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetLastGpsByGrpIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            GetLastGpsByGrpIdResponse object = new GetLastGpsByGrpIdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getLastGpsByGrpIdResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetLastGpsByGrpIdResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
