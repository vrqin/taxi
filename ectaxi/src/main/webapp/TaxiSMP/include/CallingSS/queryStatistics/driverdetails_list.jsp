...
//			var key = $('#key').textbox("getValue");
            ...
            window.location.href = path + "/files/exportDriver?" + dataurl;
        });
        ...
        */
        function acquireData(startime, endtime, key) {
            ...
            grid = $("#redataGril").datagrid({
                fit: true,
                url: path + "/callbuss/drivercallbussdetails?" + dataUrl,
                fitColumns: true,
                striped: true,
                columns: [
                    [
                        {field: 'drivername', title: '帐号', width: 100, align: 'center'},
...
//				console.info(data);
    ...
    function openrelation(data) {
        var dialog = phm.modalDialog({
            ...
            height: 580,
            closable: true,
            url: "driverdetails_info.jsp?phone=" + data + "&startime=" + globab_start + "&endtime=" + globab_end,
            buttons: [
                {
                    text: '关闭',
                    iconCls: 'icon-cancel',
