...
//                  {field: 'units', title: '所属单位', width: 100, align: 'center'},
                    {
                        field: 'gpstime', title: '最后一次信号时间', width: 100, align: 'center', sortable: true,
                        formatter: function (value) {
                            return formattime(value.time);
                        }
                    },
                    {field: 'getofftime', title: '累计离线时间', width: 100, align: 'center', sortable: true},
