...
<form id="vaildateform" method="post">
    <table class="table">
        ...
        <tr>
            ...
            <td><label><span class="required">*</span> 企业名称：</label><input id="enterprisename" class="easyui-textbox"
            ...
            <td><label><span class="required">*</span> 考评版本：</label><input id="evaluationversion" class="easyui-textbox"
                                                                           data-options="required:true"/></td>
        </tr>

        <tr>
            <td><label><span class="required">*</span> 考评等级：</label><input id="evaluationlevel" name="account"
                                                                           class="easyui-combobox"
                                                                           data-options="required:true"/></td>
            <td><label><span class="required">*</span> 总得分：</label><input id="achievement" name="account"
        ...
        <tr>
            ...
            <td><label><span class="required">*</span> 得分详细：</label><input id="achievementdet" name="account"
                                                                           class="easyui-textbox"
                                                                           data-options="required:true"/></td>
...
//		});
    ...
    function loadvalue() {
        $.ajax({
            url: path + '/enterpriseEvaluationQuery/findEnterpriseEvaluationQueryByid?id=' +${param.id},
            dataType: "json",
            type: "GET",
            success: function (data) {
                //console.info(data);
                ...
                $("#evaluationlevel").combobox('setValue', evaluationlevelFormat(data.evaluationlevel));
                $("#achievement").textbox('setValue', data.achievement);
                $("#achievementdet").textbox('setValue', data.achievementdet);
    ...
    function completedForm(dialog, grid, p) {
        ...
        var evaluationlevel = formatEvaluationlevel($("#evaluationlevel").combobox('getValue'));
        var achievement = $("#achievement").textbox('getValue');
        var achievementdet = $("#achievementdet").textbox('getValue');
        ...
        var data = {
            ...
            "achievementdet": achievementdet,
            "token": token
        };
        //console.info(data);

        var requestURL = path + "/enterpriseEvaluationQuery/saveorupdateEnterpriseEvaluationQuery";
