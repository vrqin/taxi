        ...
        */
        function yearData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#year").datagrid({
                url: path + "/driverRevenueAnalysisYear/findDriverRevenueAnalysisYearForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
                    {field: "annual", title: "年度", width: 100, align: "center", sortable: true},
                    {field: "account", title: "驾驶员姓名", width: 100, align: "center"},
                    {field: "dayshifthourse", title: "白班（小时）", width: 100, align: "center", sortable: true},
                    {field: "dayshiftmoney", title: "白班（元）", width: 100, align: "center", sortable: true},
                    {field: "lateshifthourse", title: "晚班（小时）", width: 100, align: "center", sortable: true},
                    {field: "lateshiftmoney", title: "晚班（元）", width: 100, align: "center", sortable: true},
                    {field: "summary", title: "汇总（元）", width: 100, align: "center", sortable: true},
                ]],
                idField: 'years',
                sortName: 'years',
                sortOrder: 'desc',
    	...
    	*/
        function monthData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#month").datagrid({
                url: path + "/driverRevenueAnalysisMonth/findDriverRevenueAnalysisMonthForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
    	...
    	*/
        function dayData(begintime, endtime, key) {
            var dataUrl = "sort=id&order=desc&begintime=" + begintime +
                ...
                "&key=" + key;
            $("#day").datagrid({
                url: path + "/driverRevenueAnalysisDay/findDriverRevenueAnalysisDayForPageList?" + dataUrl,
                border: false,
                fitColumns: true,
                striped: true,
                columns: [[
